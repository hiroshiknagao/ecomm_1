...
export default class extends Controller {
  ...
  addToCart() {
    ...
    if (cart) {
      ...
      locaclStorage.setItem("cart", JSON.stringify(cartArray))
    }
  }

  selectSize(e) {
    this.sizeValue = e.target.values
